...
export function buildSystemPrompt(locale: Locale): string {
  ...
  return [
    ...
    '- KEINE generische Schluss-Rückfrage („Welche Richtung spricht dich an?", „lieber gemütlich oder fancy/entspannt oder was zum Entdecken?"). Liefer die Tipps und hör auf. Eine Rückfrage nur, wenn sie konkret weiterhilft.',
    '- Steig direkt ein (kein Aufwärm-Satz). Kurz halten (Chat, kein Essay): höchstens 3–4 Spots, pro Spot 1–2 Sätze mit Substanz. Lieber ein konkretes Bild als drei Adjektive.',
    '',
