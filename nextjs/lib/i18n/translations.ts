...
const en = {
  ...
  hub: {
    ...
    deineWelt: {
      ...
      helloName: "Hi {name}",
      dockHello: "Hey.",
      dockHelloName: "Hey {name}.",
      dockQuestion: "What are we eating today?",
      dockProgress: "{count} discovered · {spots} spots on your map",
      recommendationsLabel: "Personal recommendations",
      spotPickKicker: "Spot for you",
      spotPickFallbackTitle: "Open the map",
      spotPickFallbackMeta: "Berlin pick",
      mustPickKicker: "Must Eat for you",
      mustPickLockedTitle: "Still hidden",
      mustPickFallbackMeta: "Reveal it on site",
      openSpot: "Open spot",
      openMustEat: "Open card",
  ...
  modals: {
    ...
    login: {
      ...
      mustEatGateSub: "Save this Must Eat to your deck: sign in, reveal it on site, keep it.",
...
const deOverrides: DeepPartial<TranslationsShape> = {
  ...
  hub: {
    ...
    deineWelt: {
      ...
      dockHello: "Hey.",
      dockHelloName: "Hey {name}.",
      dockQuestion: "Was essen wir heute?",
      dockProgress: "{count} entdeckt · {spots} Spots auf deiner Map",
      recommendationsLabel: "Persönliche Empfehlungen",
      spotPickKicker: "Spot für dich",
      spotPickFallbackTitle: "Map öffnen",
      spotPickFallbackMeta: "Berlin-Pick",
      mustPickKicker: "Must Eat für dich",
      mustPickLockedTitle: "Noch verdeckt",
      mustPickFallbackMeta: "Vor Ort aufdecken",
      openSpot: "Spot öffnen",
      openMustEat: "Karte öffnen",
  ...
  modals: {
    ...
    login: {
      ...
      mustEatGateSub: "Leg dieses Must Eat in dein Deck: anmelden, vor Ort aufdecken, behalten.",
