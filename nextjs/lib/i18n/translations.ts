...
const en = {
  ...
  mustEats: {
    ...
    onb2Body: "Face-down card? Head to the spot and flip it right there with a tap. New spots come in Booster Packs.",
    onbNext: "Next",
    onbStart: "Let's go",
    onbClose: "Close",
...
const deOverrides: DeepPartial<TranslationsShape> = {
  ...
  mustEats: {
    ...
    onb2Body: "Verdeckte Karte? Geh zum Spot und dreh sie vor Ort mit einem Tap um. Neue Spots gibt's in den Booster Packs.",
    onbNext: "Weiter",
    onbStart: "Los geht's",
    onbClose: "Schließen",
