...
const en = {
  ...
  mustEats: {
    ...
    closeBody: "Booster Packs unlock whole categories at once. Or just go to the spot \u2014 on site the card flips by itself.",
    closeCta: "View packs \u2192",
...
const deOverrides: DeepPartial<TranslationsShape> = {
  ...
  mustEats: {
    ...
    closeBody: "Booster Packs öffnen Kategorien auf einen Schlag. Oder geh einfach zum Spot — vor Ort dreht sich die Karte von selbst um.",
