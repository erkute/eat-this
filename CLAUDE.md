...
- **Verdeckte Karte ohne Konto:** der Tipp lässt die Karte kurz zittern (`.mustEatCardTapping`, 520 ms) und öffnet dann das Login-Modal im Starter-Modus (`openLoginModal('starter', { starterMustEatId })` plus `rememberPendingStarterCard`). Keine Tafel, kein Zwischenschritt davor.
