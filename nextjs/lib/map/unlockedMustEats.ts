 ...
 *  Signed-in: stored Firestore unlocks ∪ server-authorized face-up set
 *  (public demos, purchases and all-Berlin). Everything else stays face-down
 *  until revealed on site (50 m proximity).
 *
