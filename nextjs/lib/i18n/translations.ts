...
const en = {
  ...
  profile: {
    ...
    explainer: "Eat This curates Berlin's best places — and selected spots come with their matching Must Eat. Some you see right away, others are face-down: get close to a covered spot and the card flips on its own.",
...
const deOverrides: DeepPartial<TranslationsShape> = {
  ...
  profile: {
    ...
    explainer: "Eat This kuratiert die besten Orte Berlins \u2014 und f\u00fcr ausgew\u00e4hlte Spots gibt\u2019s das passende Must Eat gleich mit. Manche siehst du sofort, andere sind verdeckt: komm einem verdeckten Spot nah, dreht sich die Karte von selbst auf.",
