...
const en = {
  ...
  hub: {
    ...
    categories: {
      ...
      curated: "Pick a mood. Open it on the map or unlock the full pack.",
      label: "Category",
      toMap: "Open map",
      pack: "Pack",
    },
...
const deOverrides: DeepPartial<TranslationsShape> = {
  ...
  hub: {
    ...
    categories: {
      ...
      curated: "Wähl eine Richtung. Öffne sie auf der Map oder hol dir den ganzen Pack.",
      label: "Kategorie",
      toMap: "Map öffnen",
      pack: "Pack",
    },
