...
const en = {
  ...
  profile: {
    ...
    inviteHeading: 'Bring someone along',
    inviteLine:
      'Share your link. Whoever starts through it gets spots on their map — and so do you.',
...
const deOverrides: DeepPartial<TranslationsShape> = {
  ...
  profile: {
    ...
    inviteHeading: 'Bring jemanden mit',
    inviteLine:
      'Teil deinen Link. Wer dar\u00fcber startet, bekommt Spots auf seine Map — und du auch.',
    inviteCta: 'Link teilen',
    inviteCopied: 'Link kopiert',
    inviteShareTitle: 'Komm auf die Eat This Map',
