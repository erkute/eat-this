...
/**
 * Reihenfolge der Kategorie-Liste: kuratierte Bestenliste oben, Rest als
 * vollständiges A–Z-Verzeichnis darunter.
 *
 ...
 * ist. Die Rangfolge kommt deshalb aus `category.topSpots` im Studio.
 *
 * Vollständige Analyse: docs/specs/2026-08-20-kategorie-ranking.md
 */

/**
 * Unter so vielen Einträgen wird die Bestenliste nicht gerendert — die Seite
...
/**
 * Teilt die Kategorie-Liste in Bestenliste + Verzeichnis.
 *
 ...
 * auf Spots, denen die Kategorie entzogen wurde, werden übersprungen statt als
 * Lücke gerendert; Doppelreferenzen zählen einmal.
 */
export function rankCategoryRestaurants(
  ...
  for (const slug of topSpotSlugs ?? []) {
