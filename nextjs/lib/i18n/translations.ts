...
const en = {
  ...
  map: {
    ...
    nearYou: "near you",
    scopeOnMap: "On the map",
    scopeAll: "All",
    nothingInArea: "Nothing in this area. Move the map or tap \ud83d\udccd to centre on you.",
...
const deOverrides: DeepPartial<TranslationsShape> = {
  ...
  map: {
    ...
    scopeOnMap: "Auf der Karte",
    scopeAll: "Alle",
    nothingInArea: "Hier ist nichts. Bewege die Karte oder tippe \ud83d\udccd um dich zu zentrieren.",
