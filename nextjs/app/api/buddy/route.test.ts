...
describe('clientIpFromXff', () => {
  it('picks the 3rd-from-right hop (real client) for the real App Hosting shapes', () => {
    ...
    expect(clientIpFromXff('9.9.9.9,78.54.222.218,35.219.200.29,74.125.212.169')).toBe(
      '78.54.222.218'
    );
    // 2 spoofed values prepended
    expect(clientIpFromXff('1.1.1.1, 2.2.2.2,78.54.222.218,35.219.200.29,74.125.212.69')).toBe(
      '78.54.222.218'
    );
  });
