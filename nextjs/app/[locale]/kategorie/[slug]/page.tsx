                  ...
                  <p>
                    {top.length > 0
                      ...
                      : de
                        ? 'Kuratiert von '
                        : 'Curated by '}
                    {/* Höchstens ~25px hoch, also ~62px breit. Als rohes <img>
                        kam die 1660er-Vorlage mit 50 KB; `sizes` trifft
                        dieselbe 256er-Stufe wie das Logo in der SiteNav, die
                        schon im Cache liegt. */}
                    <Image
