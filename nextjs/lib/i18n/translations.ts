...
const en = {
  ...
  map: {
    ...
    pickerSortTitle: "Sort by",
    anonHintBar: "20 spots free — one email is enough",
    anonHintBarDismiss: "Dismiss",
    anonUnlockTitle: "This spot is still locked.",
    anonUnlockBody: "Sign up free and grab your starter — 20 unique spots, instantly.",
    anonUnlockCta: "Unlock now",
...
const deOverrides: DeepPartial<TranslationsShape> = {
  ...
  map: {
    ...
    filterChipSort: "Sortierung",
    pickerCategoryTitle: "Kategorie wählen",
    pickerBezirkTitle: "Bezirk wählen",
    pickerCuisineTitle: "Küche wählen",
    pickerSortTitle: "Sortieren nach",
    anonHintBar: "20 Spots geschenkt — eine E-Mail genügt",
    anonHintBarDismiss: "Schließen",
    anonUnlockTitle: "Dieser Spot ist noch zu.",
    anonUnlockBody: "Hol dir deinen Starter — 20 einzigartige Spots, kostenlos.",
    anonUnlockCta: "Jetzt freischalten",
