...
const en = {
  ...
  mustEats: {
    ...
    onbStep2: "Face-down cards are yours to flip: head to the restaurant and tap the card to reveal it.",
...
const deOverrides: DeepPartial<TranslationsShape> = {
  ...
  mustEats: {
    ...
    onbStep2: "Verdeckte Karten deckst du selbst auf: Geh zum Restaurant und dreh die Karte mit einem Tap um.",
