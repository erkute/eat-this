...
const en = {
  ...
  map: {
    ...
    starterSubline: "Unlock them with the free Welcome Pack when you sign up.",
    starterCta: "Sign up",
    spotsCountOne:  "Spot",
    ...
    starterPromoBody: "Sign in and get 20 more spots.",
...
const deOverrides: DeepPartial<TranslationsShape> = {
  ...
  map: {
    ...
    starterSubline: "Mit dem Welcome Pack schaltest du sie frei — gratis beim Anmelden.",
