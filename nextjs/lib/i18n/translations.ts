...
const en = {
  ...
  modals: {
    ...
    login: {
      ...
      modalTagline: 'Skip the guesswork. Eat the good stuff.',
      modalBadge: '20 Must Eats. Hand-picked. Always updated.',
      emailLabel: 'Email',
      magicLinkHint: "We'll email you a link to sign in. No passwords.",
...
const deOverrides: DeepPartial<TranslationsShape> = {
  ...
  mustEats: {
    ...
    onb3Title: 'Booster Packs.',
    onb3Body:
      "Neue Spots gibt's in den Booster Packs — öffne eins und leg dir frische Must Eats auf die Map.",
    onbNext: 'Weiter',
    onbStart: "Los geht's",
    onbClose: 'Schließen',
    teaserTitle: 'Must Eats',
  ...
  modals: {
    ...
    login: {
      ...
      modalTagline: 'Weniger R\u00e4tselraten. Mehr gutes Essen.',
      modalBadge: '20 Must Eats. Handverlesen. Immer aktualisiert.',
      emailLabel: 'E-Mail',
      magicLinkHint: 'Wir schicken dir einen Login-Link. Keine Passw\u00f6rter.',
