        ...
        createPortal(
          <div className={styles.backdrop} onClick={close}>
            <div
              ...
              role="dialog"
              aria-modal="true"
              aria-labelledby="must-eats-onb-title"
            ...
            >
              ...
              <h2 className={styles.title} id="must-eats-onb-title">
                {t(slide.title)}
              </h2>
              ...
              <div className={styles.dots} aria-hidden="true">
                {SLIDES.map((s, i) => (
                  <span
                    key={s.title}
                    className={i === step ? `${styles.dot} ${styles.dotOn}` : styles.dot}
                  />
                ))}
              </div>
