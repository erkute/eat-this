...
const en = {
  ...
  mustEats: {
    ...
    onbStep1: "A Must Eat is our clear recommendation: the dish to try at this restaurant.",
    onbStep2: "Step 1: Head to the restaurant and flip the face-down card there with a tap.",
    onbStep3: "Step 2: Grab Booster Packs — new spots, many with one or more Must Eats.",
    onbNext: "Next",
    onbStart: "Let's go",
    onbClose: "Close",
...
const deOverrides: DeepPartial<TranslationsShape> = {
  ...
  mustEats: {
    ...
    onbStep1: "Ein Must Eat ist unsere klare Empfehlung: das Gericht, das du in diesem Restaurant probieren solltest.",
    onbStep2: "Schritt 1: Geh zum Restaurant und dreh die verdeckte Karte vor Ort mit einem Tap um.",
    onbStep3: "Schritt 2: Hol dir Booster Packs — neue Spots, viele mit einem oder mehreren Must Eats.",
    onbNext: "Weiter",
    onbStart: "Los geht's",
    onbClose: "Schließen",
