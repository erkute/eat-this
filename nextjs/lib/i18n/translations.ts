...
const en = {
  ...
  modals: {
    ...
    login: {
      ...
      subtitleLogin: "We'll email you a one-click sign-in link. No password needed.",
...
const deOverrides: DeepPartial<TranslationsShape> = {
  ...
  modals: {
    ...
    login: {
      ...
      subtitleLogin: "Wir schicken dir einen Login-Link per E-Mail. Kein Passwort n\u00f6tig.",
      namePlaceholder: "Name",
