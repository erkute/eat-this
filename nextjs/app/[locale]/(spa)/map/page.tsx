...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const copy = en
    ? {
        title: 'Map',
        description: 'Interactive map of every Eat This restaurant and Must Eat in Berlin.',
      }
    : {
        title: 'Karte',
        description: 'Interaktive Karte aller Eat-This-Restaurants und Must Eats in Berlin.',
      };
