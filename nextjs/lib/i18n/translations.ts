...
const en = {
  ...
  map: {
    ...
    starterSubline: "20 spots on us",
    starterCta: "Sign up free",
    spotsCountOne:  "Spot",
    ...
    starterPromoTitle: "Free Booster",
    starterPromoBody: "Sign in and get 20 more spots on us.",
    starterPromoTag: "Free",
...
const deOverrides: DeepPartial<TranslationsShape> = {
  ...
  map: {
    ...
    starterTitle: "Starter Pack",
    starterSubline: "20 Spots geschenkt",
    starterCta: "Kostenlos anmelden",
    spotsCountOne:  "Spot",
    spotsCountMany: "Spots",
    phone: "Telefon",
    ...
    starterPromoTitle: "Free Booster",
    starterPromoBody: "Melde dich an und bekomme 20 weitere Spots dazu.",
    starterPromoTag: "Gratis",
