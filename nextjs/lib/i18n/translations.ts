...
const en = {
  ...
  landing: {
    stats: "Berlin · 150+ Must Eats · 200+ Restaurants",
    heroHeadline: "Probably the best food guide you know.",
    heroSubtitle: "A curated collection of Berlin's best restaurants and cafés.",
    heroEmailPlaceholder: "your@email.com",
    heroSubmit: "Sign up",
    heroSent: "Email on its way! Check your inbox and click the link.",
    aboutEyebrow: "The Concept",
    aboutHeadline: "Just order this.",
    aboutBody: "We hunt down the outstanding dishes. Every Must Eat in your collection represents a recommendation we stand behind.",
    usp1Title: "Pure Curation",
    usp1Body: "One rule: only the best food. We visit, we taste, we select.",
    usp2Title: "The Deck",
    usp2Body: "Over 150 Must Eats in more than 200 Berlin restaurants. Collect the cards, complete your deck, and know Berlin like no one else.",
    usp3Title: "Explore the Map",
    usp3Body: "Discover the city dish by dish.",
    mapEyebrow: "Explore Berlin",
    mapHeadline: "The interactive map",
    mapBody: "Find restaurants near you, filter by district, and discover individual Must Eats directly on the map.",
    mapFeature1Title: "Unlock Must Eats",
    mapFeature1Body: "Get within 250 m of a restaurant — your hidden card flips and the dish is yours.",
    mapFeature2Title: "Filter & search",
    mapFeature2Body: "Pick a district, a category, or open-now — the list narrows instantly.",
    mapFeature3Title: "What's around you",
    mapFeature3Body: "Live distance to every spot. Sort by closest and walk straight there.",
    mapFeature4Title: "Everything in one sheet",
    mapFeature4Body: "Photo, hours, insider tip and one-tap directions — no need to leave the map.",
    mapVideoPlaceholder: "Video preview",
    mapTab1: "Near You",
    mapTab2: "Districts",
    mapTab3: "Must Eats",
    selectionEyebrow: "How we choose",
    selectionHeadline: "Only the best makes the deck.",
    selectionBody: "We visit every place ourselves and talk to the chefs to find the dishes that truly stand out.",
    comingEyebrow: "What's next",
    comingHeadline: "Berlin is just the first deck.",
    comingBody: "We're expanding city by city. Istanbul, Amsterdam, and Tokyo are in preparation — more decks, more Must Eats, and exclusive merch.",
    boosterEyebrow: "Booster Pack",
    boosterHeadline: "Collect Berlin's best dishes.",
    boosterCopy: "Sign up and unlock your first Booster Pack. Collect all Must Eats, explore the map, and master the Berlin food scene.",
    boosterBenefit1: "Access to the complete Berlin Map",
    boosterBenefit2: "Your personal deck — saved",
    boosterBenefit3: "Collect all 150+ Must Eats",
    boosterStarburstLine1: "Must Eat",
    boosterStarburstLine2: "Cards",
    boosterBadgeLine1: "Unlocked instantly",
    boosterBadgeLine2: "after sign-up",
    boosterEmailPlaceholder: "your@email.com",
    boosterSubmit: "Claim Booster Pack",
    newsletterEyebrow: "Newsletter",
    newsletterHeadline: "Straight from the kitchen",
    newsletterBody: "New cities, new restaurants, new Must Eats — straight to your inbox before we go public.",
    newsletterEmailPlaceholder: "your@email.com",
    newsletterSubmit: "Subscribe",
    memoryEyebrow: "Memory",
    memoryHeadline: "Do you know Berlin's Must Eats?",
    memorySubline: "Find all 6 pairs — discover the dishes behind them.",
    memoryFound: "Found",
    memoryLeft: "Left",
    memoryMoves: "Moves",
    memoryModalClose: "Close",
    memoryModalLabel: "Well done!",
    memoryModalHeadline: "You've discovered your first 6 Berlin Must Eats.",
    memoryModalBody: "Get 10 more cards — free after sign-up.",
    memoryModalEmailPlaceholder: "your@email.com",
    memoryModalSubmit: "Sign up",
    faqEyebrow: "FAQ",
    faqHeadline: "Frequently Asked Questions",
    faqQ1: "What is EAT THIS?",
    faqA1p0: "Probably the best food guide you know.",
    faqA1p1: "A curated collection of Berlin's best restaurants. We visit every spot personally, taste through the menu — and recommend one or more dishes.",
    faqA1p2: "Every recommendation lands as a Must Eat Card in your deck. You collect, discover Berlin dish by dish. Whatever's on your card, you can order it blind.",
    faqQ2: "What is a Must Eat Card?",
    faqA2: "A Must Eat Card stands for a specific dish at a specific location — the one thing you must order there.",
    faqQ3: "What's the difference between a restaurant and a Must Eat Card?",
    faqA3: "All restaurants on our map have been curated and represent the city's favourite spots. When a dish truly stands out, it gets a Must Eat Card. We think you should eat exactly that dish there. A restaurant can have multiple Must Eats.",
    faqQ4: "How is it decided what gets a card?",
    faqA4: "We visit every place personally, talk to the chefs, and only choose what truly stands out. One rule: if it's not outstanding, it doesn't get a card. No paid content, no advertising.",
    faqQ5: "Are all recommendations truly independent?",
    faqA5: "Yes. Eat This is entirely self-funded and without advertising partners. We receive no payments from restaurants, restaurant groups, or food brands.",
    faqQ6: "Which cities are coming next?",
    faqA6: "Berlin is just the beginning — Amsterdam and Paris follow. Same rules, different cities.",
    faqQ7: "Can I suggest a restaurant or dish?",
    faqA7: "Yes — write to us at hello@eatthisdot.com. We visit every place ourselves before awarding a card.",
    sending: "Sending…",
    magicSent: "Email on its way! Check your inbox and click the link.",
  ...
  map: {
    ...
    boosterDesc: "Cafés, lunch, dinner or all of Berlin — packs from €0.99.",
    boosterCta: "Browse",
    sortLabel: "Sort by",
  ...
  modals: {
    ...
    login: {
      ...
      subtitleLogin: "Sign in by email — no password needed.",
      ...
      landingLogin: "Sign in with Email",
...
const deOverrides: DeepPartial<TranslationsShape> = {
  ...
  landing: {
    heroHeadline: "Wahrscheinlich der beste Foodguide, den du kennst.",
    heroSubtitle: "Eine kuratierte Sammlung der besten Berliner Restaurants und Cafés.",
    heroEmailPlaceholder: "deine@email.de",
    heroSubmit: "Registriere dich",
    heroSent: "E-Mail unterwegs! Schau in dein Postfach und klick auf den Link.",
    aboutEyebrow: "Das Konzept",
    aboutHeadline: "Bestell genau das.",
    aboutBody: "Wir spüren herausragende Gerichte auf. Jedes Must Eat in deiner Sammlung steht für eine Empfehlung, hinter der wir stehen.",
    usp1Title: "Reine Kuration",
    usp1Body: "Eine Regel: nur das beste Essen. Wir besuchen, wir kosten, wir wählen aus.",
    usp2Title: "Das Deck",
    usp2Body: "Über 150 Must Eats in mehr als 200 Berliner Restaurants. Sammle die Karten, vervollständige dein Deck und kenne Berlin wie kein anderer.",
    usp3Title: "Erkunde die Karte",
    usp3Body: "Entdecke die Stadt Gericht für Gericht.",
    mapEyebrow: "Erkunde Berlin",
    mapHeadline: "Die interaktive Karte",
    mapBody: "Finde Restaurants in deiner Nähe, filter nach Bezirk und entdecke einzelne Must Eats direkt auf der Karte.",
    mapFeature1Title: "Must Eats freischalten",
    mapFeature1Body: "Komm auf 250 m an ein Restaurant heran — deine verdeckte Karte dreht sich um und das Gericht ist deins.",
    mapFeature2Title: "Filtern & suchen",
    mapFeature2Body: `Wähl einen Bezirk, eine Kategorie oder „jetzt geöffnet” — die Liste passt sich sofort an.`,
    mapFeature3Title: "In deiner Umgebung",
    mapFeature3Body: "Live-Entfernung zu jedem Spot. Sortier nach Nähe und lauf direkt hin.",
    mapFeature4Title: "Alles auf einem Blick",
    mapFeature4Body: "Foto, Öffnungszeiten, Insider-Tipp und Anfahrt — alles im Sheet, ohne die Map zu verlassen.",
    mapVideoPlaceholder: "Video-Vorschau",
    mapTab1: "In deiner Nähe",
    mapTab2: "Bezirke",
    selectionEyebrow: "Wie wir auswählen",
    selectionHeadline: "Nur das Beste kommt ins Deck.",
    selectionBody: "Wir besuchen jeden Ort selbst und sprechen mit den Köchen, um die Gerichte zu finden, die wirklich herausragen.",
    comingEyebrow: "Was kommt",
    comingHeadline: "Berlin ist erst der Anfang.",
    comingBody: "Wir expandieren Stadt für Stadt. Istanbul, Amsterdam und Tokio sind in Vorbereitung - mehr Decks, mehr Must Eats und exklusives Merch.",
    boosterHeadline: "Sammle Berlins beste Gerichte.",
    boosterCopy: "Registriere dich und schalte dein erstes Booster Pack frei. Sammle alle Must Eats, erkunde die Map und meistere die Berliner Food-Szene.",
    boosterBenefit1: "Zugriff auf die komplette Berlin-Map",
    boosterBenefit2: "Dein persönliches Deck - gespeichert",
    boosterBenefit3: "Sammle alle 150+ Must Eats",
    boosterStarburstLine2: "Karten",
    boosterBadgeLine1: "Sofort freigeschaltet",
    boosterBadgeLine2: "nach Anmeldung",
    boosterEmailPlaceholder: "deine@email.de",
    boosterSubmit: "Booster Pack sichern",
    newsletterHeadline: "Gruß aus der Küche",
    newsletterBody: "Neue Städte, neue Restaurants, neue Must Eats - direkt in dein Postfach, bevor wir öffentlich davon erzählen.",
    newsletterEmailPlaceholder: "deine@email.de",
    newsletterSubmit: "Abonnieren",
    memoryHeadline: "Kennst du Berlins Must Eats?",
    memorySubline: "Finde alle 6 Paare - entdecke die Gerichte dahinter.",
    memoryModalClose: "Schließen",
    memoryModalLabel: "Gut gemacht!",
    memoryModalHeadline: "Du hast deine ersten 6 Berlin Must Eats entdeckt.",
    memoryModalBody: "Hol dir 10 weitere Karten - gratis nach Anmeldung.",
    memoryModalEmailPlaceholder: "deine@email.de",
    memoryModalSubmit: "Anmelden",
    faqHeadline: "Häufige Fragen",
    faqQ1: "Was ist EAT THIS?",
    faqA1p0: "Wahrscheinlich der beste Foodguide, den du kennst.",
    faqA1p1: "Eine kuratierte Sammlung der besten Berliner Restaurants. Wir besuchen jeden Spot persönlich, probieren uns durch die Karte - und empfehlen am Ende ein oder mehrere Gerichte.",
    faqA1p2: "Jede Empfehlung landet als Must Eat Karte in deinem Deck. Du sammelst, entdeckst Berlin Gericht für Gericht. Was auch immer auf deiner Karte steht, du kannst es blind bestellen.",
    faqQ2: "Was ist eine Must Eat Card?",
    faqA2: "Eine Must Eat Card steht für ein konkretes Gericht an einem konkreten Ort - die eine Sache, die du dort bestellen musst.",
    faqQ3: "Was ist der Unterschied zwischen einem Restaurant und einer Must Eat Card?",
    faqA3: "Alle Restaurants auf unserer Map wurden kuratiert und bilden die Lieblingsspots der Stadt. Wenn ein Gericht besonders heraussticht, bekommt es eine Must Eat Card. Wir finden, du solltest genau dieses Gericht dort essen. Ein Restaurant kann mehrere Must Eats haben.",
    faqQ4: "Wie wird entschieden, was eine Card bekommt?",
    faqA4: "Wir besuchen jeden Ort persönlich, sprechen mit den Köchinnen und Köchen und wählen nur aus, was wirklich heraussticht. Eine Regel: Ist es nicht herausragend, bekommt es keine Card. Kein bezahlter Inhalt, keine Werbung.",
    faqQ5: "Sind alle Empfehlungen wirklich unabhängig?",
    faqA5: "Ja. Eat This ist vollständig selbstfinanziert und ohne Werbepartner. Wir erhalten keine Zahlungen von Restaurants, Gastrogruppen oder Lebensmittelmarken.",
    faqQ6: "Welche Städte kommen als nächstes?",
    faqA6: "Berlin ist erst der Anfang - dann folgen Amsterdam und Paris. Gleiche Regeln, andere Städte.",
    faqQ7: "Kann ich ein Restaurant oder Gericht vorschlagen?",
    faqA7: "Ja - schreib uns an hello@eatthisdot.com. Wir besuchen aber jeden Ort selbst, bevor wir eine Karte vergeben.",
    sending: "Wird gesendet…",
    magicSent: "E-Mail unterwegs! Schau in dein Postfach und klick auf den Link.",
  ...
  map: {
    ...
    boosterDesc: "Cafés, Lunch, Dinner oder direkt ganz Berlin ab 0,99 €.",
    boosterCta: "Ansehen",
    sortLabel: "Sortieren",
  ...
  modals: {
    ...
    login: {
      ...
      subtitleLogin: "Login per E-Mail \u2014 kein Passwort n\u00f6tig.",
      namePlaceholder: "Name",
      ...
      landingLogin: "Anmelden mit E-Mail",
