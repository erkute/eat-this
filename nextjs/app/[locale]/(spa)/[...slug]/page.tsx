...
const PAGE_META: Record<string, SlugMeta> = {
  ...
  about: {
    de: {
      title: 'Über uns',
      description:
        'Was Eat This ist, wer dahinter steckt und warum ich Berlins Restaurants kuratiere – plus Remy, meine KI-Suche für deinen nächsten Spot.',
    },
    en: {
      title: 'About',
      description:
        "What Eat This is, who's behind it, why I curate Berlin's restaurants – plus Remy, my AI search for your next spot.",
    },
  },
  contact: {
    de: {
