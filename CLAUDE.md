...
- **Verdeckte Karte ohne Konto:** der Tipp öffnet sofort das Login-Modal im Starter-Modus (`openLoginModal('starter', { starterMustEatId })` plus `rememberPendingStarterCard`). Keine Tafel, kein Zwischenschritt davor.
