...
export const CATALOG: Record<string, PackDef> = {
  ...
  'category-sweets':     { packId: 'category-sweets',     stripePriceId: 'price_1TWhsEPjwS4Z8dw6wCZnDRoa', type: 'category',   slug: 'sweets',     displayName: 'Sweets',      description: 'Berlins Sweets-Spots auf deiner Map. Patisserien, Cinnamon-Bun-Spezialisten, Eisdielen mit eigener Mischung.',                                  spectrum: 'Babka. Gelato. Cookies.',         amountCents: 299  },
