...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (mapContainer && typeof L !== 'undefined') {
    const spots = [
      ...
      { name: 'Standard', district: 'Mitte', type: 'Pizza', mustEat: 'Pizza', address: 'Invalidenstraße 101, 10115 Berlin', lat: 52.5281, lng: 13.3878 },
      ...
      { name: 'Standard', district: 'Charlottenburg', type: 'Pizza', mustEat: 'Pizza', address: 'Kantstraße 56, 10625 Berlin', lat: 52.5068, lng: 13.3276 },
