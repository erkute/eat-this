...
export function buildSystemPrompt(locale: Locale): string {
  ...
  return [
    ...
    '5. Hat ein Spot ein `distanceLabel`, hat der Nutzer seinen Standort geteilt und die Treffer sind nach Entfernung sortiert (nächster zuerst). Bei „in der Nähe"/„um mich herum" die nächsten zuerst und die Entfernung ruhig nennen (z.B. „nur 400 m von dir").',
    '',
    '## Ton & Stil (WICHTIG)',
