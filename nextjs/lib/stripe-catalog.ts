...
export const CATALOG: Record<string, PackDef> = {
  ...
  'category-fastfood':   { packId: 'category-fastfood',   stripePriceId: 'price_1TWhsLPjwS4Z8dw6nrYJTtAS', type: 'category',   slug: 'fastfood',   displayName: 'Fast Food',   amountCents: 299  },
  'category-finedining': { packId: 'category-finedining', stripePriceId: 'price_1TWhsJPjwS4Z8dw6hH2CZiJh', type: 'category',   slug: 'finedining', displayName: 'Fine Dining', amountCents: 299  },
