...
const en = {
  ...
  modals: {
    ...
    login: {
      ...
      heroH1: "Starter Pack",
      heroSub: "Unlock 20 curated Berlin spots and Must Eats. They land on your map the moment you sign in.",
...
const deOverrides: DeepPartial<TranslationsShape> = {
  ...
  modals: {
    ...
    login: {
      emailPlaceholder: "deine@email.com",
      googleBtn: "Mit Google starten",
      termsLink: "AGB",
      privacyLink: "Datenschutzerkl\u00e4rung",
      sendLinkBtn: "Pack freischalten",
      ...
      kicker: "The map for people who care about food.",
      heroH1: "Starter Pack",
      heroSub: "Hol dir 20 kuratierte Berlin-Spots samt Must Eats. Sofort nach der Anmeldung auf deiner Map.",
