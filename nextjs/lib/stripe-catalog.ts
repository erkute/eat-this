...
export const CATALOG: Record<string, PackDef> = {
  'category-breakfast':  { packId: 'category-breakfast',  stripePriceId: 'price_1TWhsSPjwS4Z8dw6PaUpbHR7', type: 'category',   slug: 'breakfast',  displayName: 'Breakfast',   description: 'Berlins Frühstücks-Spots auf deiner Map. Vom klassischen deutschen Frühstück über Tel-Aviv-Brunch bis zum australischen Café.',                  spectrum: 'Shakshuka. Sauerteig. Flat White.',     amountCents: 299  },
  'category-coffee':     { packId: 'category-coffee',     stripePriceId: 'price_1TWhsNPjwS4Z8dw6Qpc9atZb', type: 'category',   slug: 'coffee',     displayName: 'Coffee',      description: 'Berlins Kaffee-Spots auf deiner Map. Cafés mit eigener Rösterei, klassische Espresso-Bars, Brew-Bars mit Single-Origin-Karte.',                spectrum: 'Crema. Slow Bar. Mikro-Röstung.',       amountCents: 299  },
  'category-dinner':     { packId: 'category-dinner',     stripePriceId: 'price_1TWhsQPjwS4Z8dw6oQS5tDni', type: 'category',   slug: 'dinner',     displayName: 'Dinner',      description: 'Berlins Dinner-Spots auf deiner Map. Concept-Restaurants, Neo-Bistros, japanisches Omakase.',                                                   spectrum: 'Kerzenlicht. Natural. Counter Seat.',   amountCents: 299  },
  'category-drinks':     { packId: 'category-drinks',     stripePriceId: 'price_1TWhsOPjwS4Z8dw6DIqjh6fs', type: 'category',   slug: 'drinks',     displayName: 'Drinks',      description: 'Berlins Bar-Spots auf deiner Map. Klassische Cocktail-Bars, Speakeasys, Naturwein-Adressen und Listening Bars mit Vinyl.',                     spectrum: 'Negroni. Hinterzimmer. Pet-Nat.',       amountCents: 299  },
  'category-fastfood':   { packId: 'category-fastfood',   stripePriceId: 'price_1TWhsLPjwS4Z8dw6nrYJTtAS', type: 'category',   slug: 'fast-food',  displayName: 'Fast Food',   description: 'Berlins Fast-Food-Spots auf deiner Map. Smash-Burger-Spezialisten, taiwanesische Bao-Bars, neue Bagel-Adressen und gehobenes Streetfood.',     spectrum: 'Smash. Dumpling. Döner 2.0.',           amountCents: 299  },
  'category-finedining': { packId: 'category-finedining', stripePriceId: 'price_1TWhsJPjwS4Z8dw6hH2CZiJh', type: 'category',   slug: 'fine-dining', displayName: 'Fine Dining', description: 'Berlins Fine-Dining-Spots auf deiner Map. Tasting-Menüs mit Konzept, Sterne-Küchen mit Saisonalität, Chef\'s Tables.',                          spectrum: '12 Gänge. Sternen-Küche. Pass-Through.', amountCents: 299  },
  'category-lunch':      { packId: 'category-lunch',      stripePriceId: 'price_1TWhsIPjwS4Z8dw6Ji9nEahS', type: 'category',   slug: 'lunch',      displayName: 'Lunch',       description: 'Berlins Lunch-Spots auf deiner Map. Mittagsmenüs jenseits der Kantine, Bowl-Bars mit Tiefe, Bistros mit täglich wechselnder Karte.',           spectrum: 'Power-Bowl. Tagesgericht. Banh Mi.',    amountCents: 299  },
  'category-pizza':      { packId: 'category-pizza',      stripePriceId: 'price_1TWhsGPjwS4Z8dw6pM1rnNNp', type: 'category',   slug: 'pizza',      displayName: 'Pizza',       description: 'Berlins Pizza-Spots auf deiner Map. Neapolitanische Klassiker mit Holzofen, römische Pinsa, amerikanische Slice.',                              spectrum: 'Holzofen. Pinsa. NY-Slice.',            amountCents: 299  },
  'category-sweets':     { packId: 'category-sweets',     stripePriceId: 'price_1TWhsEPjwS4Z8dw6wCZnDRoa', type: 'category',   slug: 'sweets',     displayName: 'Sweets',      description: 'Berlins Sweets-Spots auf deiner Map. Patisserien, Cinnamon-Bun-Spezialisten, Eisdielen mit eigener Mischung.',                                  spectrum: 'Croissant. Soft-Serve. Mochi.',         amountCents: 299  },
