...
const en = {
  ...
  mustEats: {
    ...
    onbStep1: "Some restaurants have a Must Eat: our clear recommendation — the dish to order there.",
    onbStep2: "Face-down cards are yours to flip: head to the restaurant and tap the card there to reveal it.",
    onbStep3: "Booster Packs bring you new spots — many with one or more Must Eats.",
    onbNext: "Next",
    onbStart: "Let's go",
    onbClose: "Close",
...
const deOverrides: DeepPartial<TranslationsShape> = {
  ...
  mustEats: {
    ...
    onbStep1: "Einige Restaurants haben ein Must Eat: unsere klare Empfehlung — das Gericht, das du dort probieren solltest.",
    onbStep2: "Verdeckte Karten deckst du selbst auf: Geh zum Restaurant und dreh die Karte vor Ort mit einem Tap um.",
    onbStep3: "Booster Packs bringen dir neue Spots — viele mit einem oder mehreren Must Eats.",
    onbNext: "Weiter",
    onbStart: "Los geht's",
    onbClose: "Schließen",
